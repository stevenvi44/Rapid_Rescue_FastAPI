...
# @st.cache_resource
# def load_model():
#     # Correct the path to model.pkl based on the app's folder structure
...
#         # Explanation
#         if result == 0:
#             st.info(f"The engine is predicted to be in a normal condition. The Confidence level of the machine is: {1.0 - confidence:.2%}")
#         else:
#             st.warning(f"Warning! Please investigate further. The Confidence level of the machine is: {1.0 - confidence:.2%}")
